...
import { Stack, Typography, Divider, CardMedia, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
import React from 'react';
import { useState, useEffect } from 'react';

const Newbookinginfo = ({ name, fprice, glocation, sliderImages, img, dormateroyname, price, star, rating, address }) => {
        ...
        <>
            <div class="header">
                ...
                <CardMedia
                    ...
                    alt="images"
                    height="450"
                    image={sliderImages && sliderImages.length > 0 ? sliderImages[value % sliderImages.length] : img}
                    // onClick={() => handleImageClick((value + 1) % sliderImages.length)}
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div className="dor-info">
                        ...
                        <span style={{ fontSize: '18px', fontWeight: 500 }}>Affordable Dormitory at prime location.</span> <br />
                        <FontAwesomeIcon icon={faCheck} size="lg"></FontAwesomeIcon>{' '}
                        <span style={{ fontSize: '18px', fontWeight: 500 }}>Free Cancellation.</span>
                        <br />
                        <FontAwesomeIcon icon={faCheck} size="lg"></FontAwesomeIcon>{' '}
                        <span style={{ fontSize: '18px', fontWeight: 500 }}>Reserve your room now and enjoy 30% off your entire stay.</span>
                    </div>
                            ...
                            <div style={{ marginLeft: '10px' }} className="col3-0">
                                <Stack direction="column">
                                    <div style={{ display: 'flex' }}>
                                        <span>
                                            5 <FontAwesomeIcon style={{ color: '#CDCDCD  ' }} icon={faStar}></FontAwesomeIcon>
                                        </span>
                                        <div className="progress-bar1"></div>80%
                                    </div>
                                    <div style={{ display: 'flex' }}>
                                        <span>
                                            4 <FontAwesomeIcon style={{ color: '#CDCDCD  ' }} icon={faStar}></FontAwesomeIcon>
                                        </span>
                                        <div className="progress-bar2"></div>70%
                                    </div>
                                    <div style={{ display: 'flex' }}>
                                        <span>
                                            3 <FontAwesomeIcon style={{ color: '#CDCDCD  ' }} icon={faStar}></FontAwesomeIcon>
                                        </span>
                                        <div className="progress-bar3"></div>33%
                                    </div>
                                    <div style={{ display: 'flex' }}>
                                        <span>
                                            2 <FontAwesomeIcon style={{ color: '#CDCDCD  ' }} icon={faStar}></FontAwesomeIcon>
                                        </span>
                                        <div className="progress-bar4"></div>21%
                                    </div>
                                    <div style={{ display: 'flex' }}>
                                        <span>
                                            1 <FontAwesomeIcon style={{ color: '#CDCDCD  ' }} icon={faStar}></FontAwesomeIcon>
                                        </span>
                ...
                <div class="col-3 menu">
                    ...
                    <ul>
                        ...
                        <li style={{ paddingRight: '43px', marginLeft: '10px' }}>
                            {' '}
                            <FontAwesomeIcon style={{ paddingRight: '12px' }} icon={faSuperpowers}></FontAwesomeIcon>
                            Power backup
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li style={{ marginLeft: '10px' }}>
                            <FontAwesomeIcon style={{ paddingRight: '5px' }} icon={faTv}></FontAwesomeIcon>
                            TV
                        </li>
                        <li style={{ marginLeft: '10px', paddingRight: '37px' }}>
                            <FontAwesomeIcon style={{ paddingRight: '10px' }} icon={faSquareParking}></FontAwesomeIcon>
                            Parking
                        </li>
                    </ul>
                    <ul>
                        <li style={{}}>
                            <FontAwesomeIcon icon={faJugDetergent}></FontAwesomeIcon>Laundry Facilities
                        </li>
                        <li style={{ marginLeft: '10px', paddingRight: '15px' }}>Common Areas</li>
                    ...
                    {checkindate && (
                        <div className="dor-info">
                            <Stack direction="row">
                                ...
                                <span style={{ fontSize: '18px', fontWeight: 500 }}>Check-out</span>
                                <br />
                            </Stack>
                            ...
                            <Stack direction="row">
                                ...
                                <Divider orientation="vertical" flexItem style={{ color: 'black', marginLeft: '15px' }} />
                                <div
                                    style={{
                                        border: '1px solid black',
                                        paddingLeft: '5px',
